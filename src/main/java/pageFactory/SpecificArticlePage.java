...
public class SpecificArticlePage extends Infra {
    @FindBy(xpath = "//h1[@class='ng-binding']") WebElement articleTitle;
    @FindBy(xpath = "//div[@class='ng-binding']/p") WebElement articleBody;
    @FindBy(xpath = "(//button[@class='btn btn-outline-danger btn-sm'])[1]") WebElement firstDeleteButton;
    @FindBy(xpath = "(//button[@class='btn btn-outline-danger btn-sm'])[2]") WebElement secondDeleteButton;
    @FindBy(xpath = "(//a[@class='btn btn-outline-secondary btn-sm'])[1]") WebElement firstEditButton;
    @FindBy(xpath = "(//a[@class='btn btn-outline-secondary btn-sm'])[2]") WebElement secondEditButton;
